...
#     execution_infos = await asyncio.gather(*tasks)
#     for i, execution_info in enumerate(execution_infos):
#         (got_call, got_put) = (execution_info.result.call_delta/UNIT,
#                                execution_info.result.put_delta/UNIT)
...
#         print()
#         print('Result %d:' % i)
#         print('Computed call delta: $%0.5f, Expected call price: $%0.5f' % (
#             got_call, exp_call))
#         print('Computed put delta: $%0.5f, Expected put price: $%0.5f' % (
#             got_put, exp_put))
...
#     for i, execution_info in enumerate(execution_infos):
#         # the library expects it be multiplied by .01
#         (got_call) = ((execution_info.result.vegavanna/UNIT))
